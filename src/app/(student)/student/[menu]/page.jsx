...
const menu1 = student_dhb_menu1.map((menu, index) => {
  return <Menu key={index} menu={menu} />;
});
const menu2 = student_dhb_menu2.map((menu, index) => {
  return <Menu key={index} menu={menu} />;
});
const menu3 = student_dhb_menu3.map((menu, index) => {
  return <Menu key={index} menu={menu} />;
});
