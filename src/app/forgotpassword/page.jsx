...
const Login = () => {
  const onCenterClick = useCallback(() => {
    // Please sync "Administrator/Dashboard" to the project
  }, []);

  return (
    <div className="relative bg-neutral-5 w-full h-[900px] overflow-hidden text-left text-base text-neutral-80 font-mabry-pro">
      <div className="absolute top-[calc(50%_-_274px)] left-[calc(50%_-_216px)] rounded-lg bg-grey-on-black-white box-border w-[431px] flex flex-col items-center justify-start pt-6 px-6 pb-8 gap-[48px] border-[1px] border-solid border-neutral-10">
        ...
        <div className="self-stretch flex flex-col items-center justify-start text-sm text-neutral-40 font-inter">
