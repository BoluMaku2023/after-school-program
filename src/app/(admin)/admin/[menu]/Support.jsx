        ...
        <>
          ...
          <div className="flex flex-row w-full">
            ...
            <div className="flex flex-col w-[50%]">
              ...
              <div className="flex w-full min-h-[648px] flex-col items-end gap-8 border-r-[color:var(--neutral-10,#DAD9DE)] pl-8 pr-12 pt-8 pb-12 border-r border-solid">
                <div className="flex flex-col w-full items-start gap-[18px] self-stretch">
                  <h3 className="text-[color:var(--grey-on-white-black,#000)] w-full text-base not-italic font-medium leading-6 tracking-[-0.16px]">
                    Issue notes
                  </h3>
                  <form className="w-full">
                    <textarea
                      className="flex w-full flex-col justify-end items-end gap-4 self-stretch border border-[color:var(--neutral-10,#DAD9DE)] pl-4 pr-2 pt-3 pb-2 rounded-lg border-solid placeholder:self-stretch text-[color:var(--neutral-30,#918C9B)] text-base not-italic font-normal leading-6 tracking-[-0.16px]"
                  ...
                  <div className="flex items-center gap-2 self-stretch">
                    ...
                    >
                      Change the ticket status to “Reviewed”
                    </label>
                  </div>
                </div>
                <button className="flex bg-[#1C1A24] justify-center items-center gap-1 pl-3.5 pr-[15px] py-[11px] rounded-lg">
